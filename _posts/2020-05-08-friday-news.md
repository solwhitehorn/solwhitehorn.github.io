...
### It's friday my dudes, let see what new in this world



So, some interesting things came out in the past few days.

* 05/07/2020

I think that one of the most hyped event of this week was the **XBOX Series X Event**. Unfortunately the reception was not as good as expected with one major complaint being the *Gameplay* reveal event was nothing more that long scripted cinematics. 
...
And there  is no denying it when the first video they show us, entitled *First Look Xbox Series X Gamplay* (why make it so long...), is the trailer for **Bright Memory Infinite** from the dev. at FYQD-Studio. Sure, it looks like gameplay, but the lack of UI, the heavily scripted actions and the cinematic car chase at the end are not the best you can do to truly make the viewer believe in it. And it goes on like that for the rest of the presentation with little actual gameplay and more game footage.
