...
# Demos and Trailers -- Kernel Tampering  and METAL GEAR 
...
I was going to write a long page about what I think about this demo but I decided that it would be part of an article. In a few words what I can say is that is the perfect advertisement for the incoming PS5. However, it’s nothing more than an add and some of the statement made during this demo are really discutable. As always and more since the last couple years be wary of hype building based on demos and trailers.
